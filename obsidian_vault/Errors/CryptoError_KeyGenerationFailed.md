...
type: error_variant
enum: "CryptoError"
variant: "KeyGenerationFailed"
tags: [rust, error, error/CryptoError]
---

# Error: CryptoError::KeyGenerationFailed
...
*No direct construction found (might be passed through general Result or mock tests)*
...
2. Inspect the parameters passed to [[the function]].
